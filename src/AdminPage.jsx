// src/AdminPage.jsx - Admin Code Generator
...
export default function AdminPage() {
  ...
  return (
    <div style={{ 
      ...
      <p style={{ color: '#666', marginBottom: '30px' }}>Generate access codes for Qualtrics participants</p>
      ...
      <div style={{ 
        ...
        <h3 style={{ margin: '0 0 10px 0', color: '#333' }}>How to use in Qualtrics:</h3>
        <ol style={{ margin: '10px 0', paddingLeft: '20px' }}>
          <li>Generate a code using the button above</li>
          <li>Copy the full URL</li>
          <li>In Qualtrics, use the "Redirect to a URL" option at the end of your survey</li>
          <li>Paste the URL as the redirect destination</li>
          <li>The participant will be redirected to the game with their unique access code</li>
        </ol>
      </div>
    </div>
  );
